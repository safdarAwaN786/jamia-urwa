import{j as e,M as b,g as p,f0 as O,a as A,z as x,q as k,K as Ce,r as R,aW as L,I as U,H as we,aj as Te,fB as $e,s as X,bk as Z,ag as ee,fC as ve,J as te,bN as ke,bQ as De,bR as Me,d1 as Re,bz as Fe,b as ne,aT as Se,Y as Ae,bS as oe,n as B,de as Ie,ac as Ee,f as Le,fj as Oe,bB as Ne,b0 as Y,fD as Ue,L as ie}from"./strapi-DszYkmQ4.js";import{u as D,g as m,C as _,a as V,A as Be,S as Pe,c as J}from"./index-B7VP1bCZ.js";import{d as ze,e as Q,D as We,f as Ze,a as Ve,S as He,v as Ge,s as Ke,K as qe,P as Ye,c as _e,C as Je}from"./sortable.esm-BdLred_c.js";import"./index-B-LLEtxM.js";import"./groupBy-zB8s_Hwu.js";import"./_baseEach-DnSeKOXW.js";import"./sortBy-DgHe7DmV.js";import"./_baseMap-B23lSVQ8.js";import"./index-DFjyL7IE.js";import"./index-BRVyLNfZ.js";import"./_arrayIncludesWith-BNzMLSv9.js";const Qe=t=>{let{transform:n}=t;return{...n,x:0}},Xe=b(p)`
  position: absolute;
  left: -3.4rem;
  top: 0px;
...
`,mt=({uid:t})=>{const{components:n}=D(),o=O(n,t);return e.jsxs(e.Fragment,{children:[" (",e.jsx(X,{onClick:s=>s.stopPropagation(),tag:ee,to:`/plugins/content-type-builder/component-categories/${o.category}/${o.uid}`,children:Z(o.info.displayName)}),")"]})},de=b(p)`
  height: 2.4rem;
  width: 2.4rem;
  border-radius: 50%;
  display: flex;
...
`,wt=R.memo(({disabled:t,type:n})=>{const{formatMessage:o}=A(),s=Ee(),a=yt(n),l=o({id:"content-type-builder.form.button.configure-view",defaultMessage:"Configure the view"}),i=()=>{if(t)return!1;const y=jt(n);return s(y),!1},{isLoading:c,allowedActions:f}=Le(a);return c||!f.canConfigureView&&!f.canConfigureLayout?null:e.jsx(Ct,{startIcon:e.jsx(Oe,{}),variant:"tertiary",onClick:i,disabled:t,children:l})}),Tt=b(ie.Header)`
  ...
  white-space: nowrap;
`,Lt=()=>{const{isInDevelopmentMode:t,contentTypes:n,components:o,isLoading:s}=D(),{formatMessage:a}=A(),{trackUsage:l}=ne(),{contentTypeUid:i,componentUid:c}=Ne(),{onOpenModalAddComponentsToDZ:f,onOpenModalAddField:y,onOpenModalEditSchema:v}=V(),r=i?n[i]:c?o[c]:null;if(s)return null;if(!r){const j=Object.values(n).filter(C=>C.visible===!0&&!C.plugin).map(C=>C.uid).sort();return j.length>0?e.jsx(Y,{to:`/plugins/content-type-builder/content-types/${j[0]}`}):e.jsx(Y,{to:"/plugins/content-type-builder/content-types/create-content-type"})}const d="plugin"in r&&r?.plugin!==void 0,u=i?"contentType":"component",w=r?.info?.displayName??"",T=t&&!d,F=j=>{f({dynamicZoneTarget:j,targetUid:r.uid})},M=()=>{if("kind"in r){r?.kind==="collectionType"&&l("willEditNameOfContentType"),r?.kind==="singleType"&&l("willEditNameOfSingleType"),v({modalType:u,forTarget:u,targetUid:r.uid,kind:r?.kind});return}v({modalType:u,forTarget:u,targetUid:r.uid})},I=a({id:m("table.button.no-fields"),defaultMessage:"Add new field"}),S=a({id:m("button.attributes.add.another"),defaultMessage:"Add another field"}),g=r.status==="REMOVED",h=t&&e.jsxs(x,{gap:2,children:[e.jsx(wt,{type:r,disabled:r.status==="NEW"||g},"link-to-cm-settings-view"),e.jsx(B,{startIcon:e.jsx(te,{}),variant:"tertiary",onClick:M,disabled:!T||g,children:a({id:"app.utils.edit",defaultMessage:"Edit"})}),e.jsx(B,{startIcon:e.jsx(L,{}),variant:"secondary",minWidth:"max-content",onClick:()=>{y({forTarget:u,targetUid:r.uid})},disabled:g,children:r.attributes.length===0?I:S})]});return e.jsxs(e.Fragment,{children:[e.jsx(oe.contentTypeBuilder.Introduction,{children:e.jsx(p,{})}),g&&e.jsx(x,{background:"danger100",justifyContent:"center",padding:4,children:e.jsxs(x,{gap:2,children:[e.jsx(Ue,{fill:"danger600",height:"2rem",width:"2rem"}),e.jsx(k,{children:a({id:m("table.warning.deleted"),defaultMessage:"This {kind} has been deleted"},{kind:r.modelType==="contentType"?"Content Type":"Component"})})]})}),e.jsx(Tt,{id:"title",primaryAction:h,title:Z(w)}),e.jsx(ie.Content,{children:e.jsx(p,{background:"neutral0",shadow:"filterShadow",hasRadius:!0,overflow:"auto",borderColor:"neutral150",children:e.jsx(ue,{type:r,addComponentToDZ:F,isMain:!0})})})]})};export{Lt as default};
