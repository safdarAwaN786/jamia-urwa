...
export interface ApiFormFieldFormField extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['text', 'email', 'number', 'select', 'file', 'date']
    > &
...
export interface ApiFormForm extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Reusable form definition';
    displayName: 'Form';
    pluralName: 'forms';
    singularName: 'form';
  };
...
export interface ApiMyTestMyTest extends Struct.CollectionTypeSchema {
  collectionName: 'my-tests';
  info: {
    description: 'Organize your content into categories';
    displayName: 'My-Test';
    pluralName: 'my-tests';
    singularName: 'my-test';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiNewNew extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    featured_media: Schema.Attribute.Media<
  ...
  attributes: {
    content_blocks: Schema.Attribute.DynamicZone<
      [
        ...
        'shared.media',
        'shared.link-item',
        'shared.important-links',
        'shared.hero',
        'shared.gallery-block',
        'shared.form-block',
        'shared.events-calendar',
        'shared.director-message',
        'shared.contact-widget',
        'shared.carousal',
        'shared.carousal-item',
        'shared.announcement-list',
        'shared.announcement-item',
      ]
    > &
    ...
    publishedAt: Schema.Attribute.DateTime;
    sea_description: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiProgramProgram extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    program_type: Schema.Attribute.Enumeration<['seminary', 'contemporary']>;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::my-test.my-test': ApiMyTestMyTest;
